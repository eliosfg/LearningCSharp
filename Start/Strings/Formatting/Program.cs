...
namespace Formatting
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("{0,12} {1,12} {2,12} {3,12}", quarters[0], quarters[1], quarters[2], quarters[3]);   // Right aligned by default with 12 spaces
            Console.WriteLine("{0,12:C0} {1,12:C0} {2,12:C0} {3,12:C0}", sales[0], sales[1], sales[2], sales[3]);   // Currency with no decimal places
            Console.WriteLine("{0,12:P0} {1,12:P0} {2,12:P1} {3,12:P2}", intlMixPct[0], intlMixPct[1], intlMixPct[2], intlMixPct[3]);   // Percent with: P0 no decimal places, P1 1 decimal place, P2 2 decimal places
            Console.WriteLine();
            
            // Left align with negative sign
